...
import("leidenalg", delay_load = TRUE)
import("igraph", delay_load = TRUE)
...
# if(py_available()){
#   use_python(system("whereis pip"))
#   system("pip install leidenalg python-igraph numpy scipy")
# }
module <- py_available() && py_numpy_available() && reticulate::py_module_available("leidenalg") && reticulate::py_module_available("igraph")
print(py_available())

print(module)
# library("reticulate")
# if(! "r-reticulate" %in% conda_list()$name) reticulate::conda_create("r-reticulate")
# reticulate::use_condaenv("r-reticulate")
# conda_install(env = "r-reticulate", c("leidenalg", "numpy", "scipy"), forge = TRUE)
```
