...
```{r, eval=!module,echo=FALSE, message=FALSE, warning=FALSE}
...
Here we can see partitions in the plotted results. The nodes that are more interconnected have been paritioned into separate clusters.
...
In particular, the resolution parameter can tue the numberof clusters to be detected.
